...
@section('content')
 <section id="Content" class="bg-portto-black flex min-h-screen">
            ...
            >
                <div
                    class="flex flex-col bg-white p-[30px] gap-5 rounded-[30px] w-[580px]"
                >
                    <div class="flex h-10 items-start overflow-hidden">
                        <img
                            src="{{asset('images/logos/logo-testi5.svg')}}"
                            class="h-full object-contain"
                            alt="photo"
                        />
                    </div>
                    <p class="font-semibold text-[22px] leading-[40px]">
                        She helped us to build our first prototype to win our
                        investor and early users heart that generate huge
                        attraction.
                    </p>
            ...
            >
                ...
                <form action="" class="flex flex-col gap-5 w-[550px]">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <label
                            class="flex flex-col gap-[10px] font-semibold w-full"
                        >
